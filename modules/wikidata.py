...
class BALMWikidata(object):
    def __init__(self, argparse=False, params={}, sqldb=None):
        ...
        parameters.
        """
        self.title = "JSON dump of all Wikibase entries on %s generated on %s"
        self.desc = "This is a JSON dump of all Wikibase entries on %s that "
    ...
    def getItemMetadata(self, database, dumpdate):
        ...
        metadata = {
            ...
            'title': self.title % (dumpdate),
            'description': self.desc % (dumpdate)
        }
        return metadata
